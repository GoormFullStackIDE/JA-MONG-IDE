...
public class MemberResponseDto {
    ...
    // 생성자를 만든다.
    public MemberResponseDto(String memberEmail, String memeberName, String memberPhone, String memeberAdres, String memberFile, LocalDateTime memberCreated, LocalDateTime memberLastLogin) {
